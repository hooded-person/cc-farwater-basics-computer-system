...
local h = fs.open(config.data.prog_detector.logfile, "a")
...
-- START CONFIGURATION TODO: move this to config.lon
local subscribed = config.data.prog_detector.subscribed
local excluded = config.data.prog_detector.excluded
local hate = {}
